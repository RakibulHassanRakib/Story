...
//TODO: Step 7 - Uncomment the lines below to include storyData as a private property in StoryBrain. Hint: You might need to change something in story.dart to make this work.
  ...
  void nextStory(int choiceNuber) {
    if (choiceNuber == 1 && _storyNumber == 0) {
      _storyNumber = 2;
    } else if (choiceNuber == 2 && _storyNumber == 0) {
      _storyNumber = 1;
    } else if (choiceNuber == 1 && _storyNumber == 1) {
      _storyNumber = 2;
    } else if (choiceNuber == 2 && _storyNumber == 1) {
      _storyNumber = 3;
    } else if (choiceNuber == 1 && _storyNumber == 2) {
      _storyNumber = 5;
    } else if (choiceNuber == 2 && _storyNumber == 2) {
      _storyNumber = 4;
